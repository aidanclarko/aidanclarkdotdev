  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row items-center justify-center px-6 md:px-10 py-12 md:py-20 gap-10">
        ...
        <div className="flex justify-center px-6 md:px-10 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 px-6 md:px-10">
        <div className="bg-card rounded-xl shadow-md p-6">
          ...
          <p className="leading-relaxed text-muted-foreground text-sm sm:text-base">
            I&apos;m a Computer Science student and software engineer passionate about building
            practical tools and clean user experiences. I&apos;ve worked on projects ranging from
            web apps in React and Next.js, Applications in Dart and Flutter, and Automation Tools.
            Currently focused on software. Always curious, always learning.
          </p>
        </div>
